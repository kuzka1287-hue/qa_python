...
class TestBooksCollector:
    ...
    # Тест добавления двух книг (исправлен вызов метода)
    def test_add_new_book_add_two_books(self, collector):
        collector.add_new_book('Гордость и предубеждение и зомби')
        collector.add_new_book('Что делать, если ваш кот хочет вас убить')
        # Исправлено: get_books_rating -> get_books_genre
    ...
    # Тест: одна и та же книга добавляется только один раз (по заданию)
    ...
    # Тест добавления в избранное дубликата (не должно появиться второй раз)
    ...
    def test_delete_book_from_favorites_success(self, collector):
        ...
        # Исправлено: русский текст заменён на корректный assert
